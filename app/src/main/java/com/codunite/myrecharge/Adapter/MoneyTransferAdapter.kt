...
public class MoneyTransferAdapter(
    context: Context,
    movies: MutableList<com.codunite.myrecharge.Models.MoneyTransferReportModel>?
) :
    RecyclerView.Adapter<RecyclerView.ViewHolder?>() {
    private var movies: MutableList<com.codunite.myrecharge.Models.MoneyTransferReportModel>?
    private val context: Context
    private var isLoadingAdded = false
    var TAG = "@@PagingAdapter"
    fun getMovies(): List<com.codunite.myrecharge.Models.MoneyTransferReportModel>? {
        return movies
    }

    fun setMovies(movies: MutableList<com.codunite.myrecharge.Models.MoneyTransferReportModel>?) {
        this.movies = movies
    }
    ...
    private fun getViewHolder(
        ...
        val v1 = inflater.inflate(R.layout.money_transfer_adapter, parent, false)
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        fun add(mc: com.codunite.myrecharge.Models.MoneyTransferReportModel) {
        movies!!.add(mc)
        notifyItemInserted(movies!!.size - 1)
    }

    fun addAll(mcList: List<com.codunite.myrecharge.Models.MoneyTransferReportModel>) {
        for (mc in mcList) {
            add(mc)
        }
    }

    fun remove(city: com.codunite.myrecharge.Models.MoneyTransferReportModel?) {
    ...
    fun addLoadingFooter() {
        isLoadingAdded = true
        add(com.codunite.myrecharge.Models.MoneyTransferReportModel())
    }
    ...
    fun getItem(position: Int): com.codunite.myrecharge.Models.MoneyTransferReportModel {
...
//        val txt_transactionID: TextView
...
//            txt_transactionID = itemView.findViewById<View>(R.id.txt_transactionID) as TextView
            ...
            ITEM -> {
                ...
                try {
                    if (movie.id == null) {
                        ...
                        mItemList!!.txt_id.text = "A/C no : "+movie.accountNumber.toString()
                        mItemList!!.txt_description.text = movie.customerName.toString()+" "+movie.adddate+" "+movie.transtime.toString()+" \n"+movie.transID.toString()+""
                        mItemList!!.txt_Amount.text = movie.amount.toString()+" "
//                        mItemList!!.txt_transactionID.text =
