...
public class HistoryAdapter(
    context: Context,
    movies: MutableList<com.codunite.myrecharge.Models.HistoryModel>?
) :
    RecyclerView.Adapter<RecyclerView.ViewHolder?>() {
    private var movies: MutableList<com.codunite.myrecharge.Models.HistoryModel>?
    private val context: Context
    private var isLoadingAdded = false
    var TAG = "@@PagingAdapter"
    fun getMovies(): List<com.codunite.myrecharge.Models.HistoryModel>? {
        return movies
    }

    fun setMovies(movies: MutableList<com.codunite.myrecharge.Models.HistoryModel>?) {
        this.movies = movies
    }
    ...
    fun add(mc: com.codunite.myrecharge.Models.HistoryModel) {
        movies!!.add(mc)
        notifyItemInserted(movies!!.size - 1)
    }

    fun addAll(mcList: List<com.codunite.myrecharge.Models.HistoryModel>) {
        for (mc in mcList) {
            add(mc)
        }
    }

    fun remove(city: com.codunite.myrecharge.Models.HistoryModel?) {
    ...
    fun addLoadingFooter() {
        isLoadingAdded = true
        add(com.codunite.myrecharge.Models.HistoryModel())
    }
    ...
    fun getItem(position: Int): com.codunite.myrecharge.Models.HistoryModel {
